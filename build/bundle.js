...
var app = (function () {
    ...
    const active$2 = localStorage.getItem('active') ? writable(JSON.parse(localStorage.getItem('active'))) : writable('Select Term');
    active$2.subscribe(value => {
    ...
    const crns = sessionStorage.getItem('crns') ? writable(JSON.parse(sessionStorage.getItem('crns'))) : writable([]);
    ...
    ***************************************************************************** */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 28, 8, 1121);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 26, 12, 1027);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 30, 12, 1209);
    			add_location(br, file, 30, 83, 1280);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_store(active$2, "active");
    	component_subscribe($$self, active$2, $$value => $$invalidate(1, $active = $$value));
    	...
    	const toggleTab = direction => {
    		if (direction == "prev" && tabs.indexOf($active) > 0) active$2.set(tabs[tabs.indexOf($active) - 1]); else if (direction == "next" && tabs.indexOf($active) + 1 < tabs.length) active$2.set(tabs[tabs.indexOf($active) + 1]);
    	};
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 74, 4, 2161);
    			attr_dev(div, "class", div_class_value = "card " + /*$theme*/ ctx[5] + " svelte-lmzvpb");
    			add_location(div, file$4, 73, 3, 2128);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$4, 54, 2, 1428);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 9, 12, 310);
    			attr_dev(div1, "class", div1_class_value = "modal " + /*$theme*/ ctx[1] + " svelte-llgztg");
    			add_location(div1, file$6, 8, 8, 268);
    			attr_dev(div2, "class", "backdrop svelte-llgztg");
    			add_location(div2, file$6, 7, 4, 157);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div2, anchor);
    			append_dev(div2, div1);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div2, "click", self(/*click_handler*/ ctx[4]), false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*$theme*/ 2 && div1_class_value !== (div1_class_value = "modal " + /*$theme*/ ctx[1] + " svelte-llgztg")) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fade, theme, showModal, $theme });
    	...
    	return [showModal, $theme, $$scope, slots, click_handler];
    }
    ...
    /* src\TermPlan.svelte generated by Svelte v3.32.0 */

    const { console: console_1$2 } = globals;
    const file$7 = "src\\TermPlan.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h10 = element("h1");
    			h10.textContent = "Export to Google Calendar";
    			t1 = space();
    			span = element("span");
    			span.textContent = "Learn how to import iCal file to Google Calender";
    			t3 = space();
    			a = element("a");
    			a.textContent = "here";
    			t5 = space();
    			...
    			t10 = space();
    			h11 = element("h1");
    			h11.textContent = "Upload term plan to RWeb";
    			t12 = space();
    			...
    			t19 = text(" Set current schedule as preferred term plan");
    			t20 = space();
    			...
    			t23 = space();
    			h12 = element("h1");
    			h12.textContent = "Schedule crns as plaintext";
    			t25 = space();
    			textarea = element("textarea");
    			attr_dev(h10, "class", "svelte-pftphw");
    			add_location(h10, file$7, 52, 4, 1352);
    			add_location(span, file$7, 53, 4, 1392);
    			attr_dev(a, "href", "https://support.google.com/calendar/answer/37118#import_to_gcal");
    			attr_dev(a, "class", "svelte-pftphw");
    			add_location(a, file$7, 53, 67, 1455);
    			add_location(br0, file$7, 53, 150, 1538);
    			add_location(br1, file$7, 53, 155, 1543);
    			attr_dev(button0, "class", "svelte-pftphw");
    			add_location(button0, file$7, 54, 4, 1553);
    			add_location(hr0, file$7, 55, 4, 1638);
    			attr_dev(h11, "class", "svelte-pftphw");
    			add_location(h11, file$7, 56, 4, 1648);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Term plan name");
    			set_style(input0, "width", "50%");
    			add_location(input0, file$7, 57, 4, 1687);
    			add_location(br2, file$7, 57, 96, 1779);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "RWeb username");
    			set_style(input1, "width", "50%");
    			add_location(input1, file$7, 58, 4, 1789);
    			add_location(br3, file$7, 58, 94, 1879);
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "placeholder", "RWeb password");
    			set_style(input2, "width", "50%");
    			add_location(input2, file$7, 59, 4, 1889);
    			add_location(br4, file$7, 59, 98, 1983);
    			attr_dev(input3, "type", "checkbox");
    			add_location(input3, file$7, 60, 39, 2028);
    			set_style(label, "padding", "0 0 15px 0");
    			add_location(label, file$7, 60, 4, 1993);
    			attr_dev(button1, "class", "svelte-pftphw");
    			add_location(button1, file$7, 61, 4, 2136);
    			add_location(hr1, file$7, 62, 4, 2191);
    			attr_dev(h12, "class", "svelte-pftphw");
    			add_location(h12, file$7, 63, 4, 2201);
    			set_style(textarea, "width", "50%");
    			set_style(textarea, "height", "15em");
    			textarea.value = textarea_value_value = [...new Set(/*$crns*/ ctx[4])].join("\n");
    			add_location(textarea, file$7, 64, 4, 2242);
    			set_style(div, "position", "relative");
    			set_style(div, "max-height", "calc(100vh - 5%)");
    			set_style(div, "overflow", "auto");
    			add_location(div, file$7, 51, 0, 1267);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*plan_name*/ ctx[0]);
    			append_dev(div, t13);
    			append_dev(div, br2);
    			append_dev(div, t14);
    			...
    			input3.checked = /*preferred*/ ctx[3];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*plan_name*/ 1 && input0.value !== /*plan_name*/ ctx[0]) {
    				set_input_value(input0, /*plan_name*/ ctx[0]);
    			}
    			...
    			if (dirty & /*preferred*/ 8) {
    				input3.checked = /*preferred*/ ctx[3];
    			}

    			if (dirty & /*$crns*/ 16 && textarea_value_value !== (textarea_value_value = [...new Set(/*$crns*/ ctx[4])].join("\n"))) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	validate_store(crns, "crns");
    	component_subscribe($$self, crns, $$value => $$invalidate(4, $crns = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("TermPlan", slots, []);
    	let plan_name = "";
    	let username = "";
    	let password = "";
    	let preferred = true;
    	...
    	function handle() {
    		...
    		fetch("https://jcurda-api.herokuapp.com/term_plan", {
    			method: "post",
    			body: JSON.stringify({
    				plan_name,
    				username,
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<TermPlan> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => window.alert("this does nothing rn");

    	function input0_input_handler() {
    		plan_name = this.value;
    		$$invalidate(0, plan_name);
    	}
    	...
    	function input3_change_handler() {
    		preferred = this.checked;
    		$$invalidate(3, preferred);
    	}

    	const click_handler_1 = () => handle();
    	...
    	$$self.$inject_state = $$props => {
    		if ("plan_name" in $$props) $$invalidate(0, plan_name = $$props.plan_name);
    		if ("username" in $$props) $$invalidate(1, username = $$props.username);
    		if ("password" in $$props) $$invalidate(2, password = $$props.password);
    		if ("preferred" in $$props) $$invalidate(3, preferred = $$props.preferred);
    	};
    ...
    class TermPlan extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot$1(ctx) {
    	let termplan;
    	let current;
    	termplan = new TermPlan({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(termplan.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(termplan, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(termplan.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(termplan.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(termplan, detaching);
    		}
    	};
    ...
    function create_fragment$8(ctx) {
    	...
    	let input_max_value;
    	let t6;
    	let t7_value = /*items*/ ctx[2].length + "";
    	let t7;
    	let t8;
    	let span2;
    	let t9;
    	...
    	if (/*showModal*/ ctx[0] !== void 0) {
    		modal_props.showModal = /*showModal*/ ctx[0];
    	}
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(modal, div4, null);
    			append_dev(div4, t2);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_showModal && dirty & /*showModal*/ 1) {
    				...
    				modal_changes.showModal = /*showModal*/ ctx[0];
    				add_flush_callback(() => updating_showModal = false);
    			}

    			modal.$set(modal_changes);

    			if (!current || dirty & /*idx*/ 8 && input_value_value !== (input_value_value = /*idx*/ ctx[3] + 1)) {
    				prop_dev(input, "value", input_value_value);
    			}

    			if (!current || dirty & /*items*/ 4 && input_max_value !== (input_max_value = /*items*/ ctx[2].length)) {
    				attr_dev(input, "max", input_max_value);
    			}

    			if ((!current || dirty & /*items*/ 4) && t7_value !== (t7_value = /*items*/ ctx[2].length + "")) set_data_dev(t7, t7_value);

    			if (!current || dirty & /*loaded*/ 2) {
    				set_style(div4, "height", (/*loaded*/ ctx[1] ? 100 : 0) + "%");
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	//     {
    	//         fetch(`https://jcurda-api.herokuapp.com/?term=${$term}&course=${element}`)
    	//             .then((data) => data.json())
    	//             .then((jsonData) => 
    	//             {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<Scheduler> was created with unknown prop '${key}'`);
    	});
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$9, 18, 2, 460);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(12:1) {#if $active == 'Select Term'}",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(body, file$9, 9, 0, 248);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
